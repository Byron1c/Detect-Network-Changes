...
namespace Microsoft.WindowsAPICodePack.Net
{
    ...
    public class Network
    {
        ...
        public DateTime ConnectedTime
        {
            get
            {
                network.GetTimeCreatedAndConnected(out uint dummy1, out uint dummy2, out uint low, out uint high);
                long time = high;
        ...
        public DateTime CreatedTime
        {
            get
            {
                network.GetTimeCreatedAndConnected(out uint low, out uint high, out uint dummy1, out uint dummy2);
                long time = high;
